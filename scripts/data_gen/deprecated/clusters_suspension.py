...
VOI_SHAPE = (
    ...
    1856,
    464,
)  # (400, 400, 236) # (1856, 1856, 236) # (1856, 1856, 464) # (400, 400, 464) # (924, 924, 300) # vx
VOI_OFFS = (
    (4, 1852),
    (4, 1852),
    (32, 432),
)  # ((4,396), (4,396), (4,232)) # ((4,1852), (4,1852), (4,232)) # vx
VOI_VSIZE = 2.2  # A/vx
...
PROTEINS_LIST = [
    "in/ribo_v2.pns",
    "in/prot_v2.pns",
]  # ['in/ribo_v2.pns', 'in/prot_v2.pns', 'in/ribo_30S_v2.pns', 'in/ribo_50S_v2.pns', 'in/prot_sc_v2.pns',
# 'in/prot_dc_v2.pns']
